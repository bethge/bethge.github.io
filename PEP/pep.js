...
(function (global, factory) {
  ...
  var dispatcher = {
    ...
    leaveOut: function(event) {
      this.out(event);
      this.propagate(event, this.leave.bind(this), false);
    },
    enterOver: function(event) {
      this.over(event);
      this.propagate(event, this.enter.bind(this), true);
    },
    ...
    setCapture: function(inPointerId, inTarget) {
      ...
      var e = new _PointerEvent('gotpointercapture');
    ...
    releaseCapture: function(inPointerId) {
      ...
      if (t) {
        var e = new _PointerEvent('lostpointercapture');
        e.pointerId = inPointerId;
  ...
  var touchEvents = {
    ...
    overDown: function(inPointer) {
      ...
      _dispatcher.enterOver(inPointer);
    ...
    upOut: function(inPointer) {
      if (!this.scrolling) {
        ...
        _dispatcher.leaveOut(inPointer);
      }
